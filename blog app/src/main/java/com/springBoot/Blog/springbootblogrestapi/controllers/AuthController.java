...
//@api -  marks class as swagger resource
// to provide a metadata about this controller
...
public class AuthController {
    ...
    public ResponseEntity<JWTAuthResponse> authenticateUser(@RequestBody LoginDto loginDto){
        ...
        // get token form tokenProvider class
    ...
    public ResponseEntity<?> registerUser(@RequestBody SignUpDto signUpDto){
        ...
        // create user object and set all the values from signup dto to user object
        User user = new User();
